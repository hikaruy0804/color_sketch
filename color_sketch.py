...
def generate_color_variations(hex_color):
    adjustments = {
        ...
        'lightness_variation': [
            (0, 0, random.uniform(0.4, 0.7)), (0, 0, random.uniform(-0.7, -0.4)),
            (0, 0, random.uniform(0.1, 0.3)), (0, 0, random.uniform(-0.3, -0.1))
        ],
        'saturation_variation': [
            (0, random.uniform(0.4, 0.7), 0), (0, random.uniform(-0.7, -0.4), 0),
            (0, random.uniform(0.1, 0.3), 0), (0, random.uniform(-0.3, -0.1), 0)
        ],
        'same_tone': [
